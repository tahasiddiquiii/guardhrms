...
class ApprovalRequestScreen2 extends StatefulWidget {
  const ApprovalRequestScreen2({super.key});

  @override
  State<ApprovalRequestScreen2> createState() => _ApprovalRequestScreen2State();
}

class _ApprovalRequestScreen2State extends State<ApprovalRequestScreen2> {
  @override
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              _buildText(
                                  title: "Name :", fontWeight: FontWeight.bold),
                              _buildText(
                                  title: "Suhas Bansali ",
                          ...
                          Row(
                            children: [
                              _buildText(
                                  ...
                                  fontWeight: FontWeight.bold),
                              _buildText1(
                                  title: "123456", fontWeight: FontWeight.w400),
                            ],
                          ),
