...
class LeaveApprovalScreen01 extends StatefulWidget {
  const LeaveApprovalScreen01({super.key});

  @override
  State<LeaveApprovalScreen01> createState() => _LeaveApprovalScreen01State();
}

class _LeaveApprovalScreen01State extends State<LeaveApprovalScreen01> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: _showInitialImage
          ? Center(
              child: Image.asset(
                  'assets/disapper.png')) // Adjust the asset path as needed.
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      showDialog(
                                        context: context,
                                        builder: (BuildContext context) {
                                          return const SuccessDialog1(); // Using the custom dialog widget
                                        },
                                      );
                                      // Waiting for 5 seconds
                                      await Future.delayed(
...
class SuccessDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Image.asset('assets/approved_leave.png'),
...
class SuccessDialog1 extends StatelessWidget {
  const SuccessDialog1({Key? key}) : super(key: key);
