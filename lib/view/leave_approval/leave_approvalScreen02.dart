...
class LeaveApprovalScreen02 extends StatefulWidget {
  const LeaveApprovalScreen02({super.key});

  @override
  State<LeaveApprovalScreen02> createState() => _LeaveApprovalScreen02State();
}

class _LeaveApprovalScreen02State extends State<LeaveApprovalScreen02> {
