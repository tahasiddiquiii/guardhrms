...
class VerifyOtpScreen3 extends StatefulWidget {
  const VerifyOtpScreen3({super.key});

  @override
  State<VerifyOtpScreen3> createState() => _VerifyOtpScreen3State();
}

class _VerifyOtpScreen3State extends State<VerifyOtpScreen3> {
  String otps = '';
