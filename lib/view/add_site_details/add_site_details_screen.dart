...
import 'package:security_app/view/add_site_details/remove_add_site_details_screen.dart';
...
class AddSiteDetailsScreen extends StatefulWidget {
  const AddSiteDetailsScreen({super.key});

  @override
  State<AddSiteDetailsScreen> createState() => _AddSiteDetailsScreenState();
}

class _AddSiteDetailsScreenState extends State<AddSiteDetailsScreen> {
