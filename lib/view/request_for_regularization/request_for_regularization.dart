...
class RequestForRegularisationScreen extends StatefulWidget {
  const RequestForRegularisationScreen({super.key});

  @override
  State<RequestForRegularisationScreen> createState() =>
      _RequestForRegularisationScreenState();
}

class _RequestForRegularisationScreenState
    extends State<RequestForRegularisationScreen> {
  @override
      ...
      body: Column(
        children: [
          ...
          _buildTextHeader(
              ...
              size: 18),
          buildVSpacer(20),
          _buildText(title: "Revise Duty Hours"),
          Padding(
