...
class EmployeeDetailScreen1 extends StatefulWidget {
  const EmployeeDetailScreen1({super.key});

  @override
  State<EmployeeDetailScreen1> createState() => _EmployeeDetailScreen1State();
}

class _EmployeeDetailScreen1State extends State<EmployeeDetailScreen1> {
  @override
