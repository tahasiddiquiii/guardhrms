...
import 'package:security_app/view/register_screen/register_screen4.dart';

class EmployeeDetailScreen4 extends StatefulWidget {
  const EmployeeDetailScreen4({super.key});

  @override
  State<EmployeeDetailScreen4> createState() => _EmployeeDetailScreen4State();
}

class _EmployeeDetailScreen4State extends State<EmployeeDetailScreen4> {
  @override
