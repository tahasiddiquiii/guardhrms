...
import 'package:security_app/view/register_screen/register_screen2.dart';

class EmployeeDetailScreen2 extends StatefulWidget {
  const EmployeeDetailScreen2({super.key});

  @override
  State<EmployeeDetailScreen2> createState() => _EmployeeDetailScreen2State();
}

class _EmployeeDetailScreen2State extends State<EmployeeDetailScreen2> {
  @override
