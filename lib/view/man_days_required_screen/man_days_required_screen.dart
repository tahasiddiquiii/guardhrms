...
class ManDaysRequiredScreen extends StatefulWidget {
  const ManDaysRequiredScreen({super.key});

  @override
  State<ManDaysRequiredScreen> createState() => _ManDaysRequiredScreenState();
}

class _ManDaysRequiredScreenState extends State<ManDaysRequiredScreen> {
  @override
