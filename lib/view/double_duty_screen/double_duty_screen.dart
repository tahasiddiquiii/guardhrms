...
class DoubleDutyScreen extends StatefulWidget {
  const DoubleDutyScreen({super.key});

  @override
  State<DoubleDutyScreen> createState() => _DoubleDutyScreenState();
}

class _DoubleDutyScreenState extends State<DoubleDutyScreen> {
  @override
