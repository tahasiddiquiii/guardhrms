...
class TotalDeploymentDetailsScreen extends StatefulWidget {
  const TotalDeploymentDetailsScreen({super.key});

  @override
  State<TotalDeploymentDetailsScreen> createState() =>
      _TotalDeploymentDetailsScreenState();
}

class _TotalDeploymentDetailsScreenState
    extends State<TotalDeploymentDetailsScreen> {
  @override
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    buildHSpacer(100),
                    _buildTextHeader(
                        title: "Total Deployment Details",
