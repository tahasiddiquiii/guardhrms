...
class UnMappedDiteDetailsScreen extends StatefulWidget {
  const UnMappedDiteDetailsScreen({super.key});

  @override
  State<UnMappedDiteDetailsScreen> createState() =>
      _UnMappedDiteDetailsScreenState();
}

class _UnMappedDiteDetailsScreenState extends State<UnMappedDiteDetailsScreen> {
  @override
