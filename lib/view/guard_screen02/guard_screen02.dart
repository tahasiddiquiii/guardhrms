...
import 'package:security_app/view/guard_screen02/guard_profile_screen02.dart';
...
class GuardScreen02 extends StatefulWidget {
  const GuardScreen02({super.key});

  @override
  State<GuardScreen02> createState() => _GuardScreen02State();
}

class _GuardScreen02State extends State<GuardScreen02> {
  @override
          ...
          GestureDetector(
            onTap: () {
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (context) => GuardProfileScreen02()));
            },
            child: Card(
              elevation: 5,
              child: Container(
