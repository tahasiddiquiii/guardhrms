...
class MappedSiteDetailsScreen extends StatefulWidget {
  const MappedSiteDetailsScreen({super.key});

  @override
  State<MappedSiteDetailsScreen> createState() =>
      _MappedSiteDetailsScreenState();
}

class _MappedSiteDetailsScreenState extends State<MappedSiteDetailsScreen> {
  @override
