...
class SalarySlipScreen4 extends StatefulWidget {
  const SalarySlipScreen4({super.key});

  @override
  State<SalarySlipScreen4> createState() => _SalarySlipScreen4State();
}

class _SalarySlipScreen4State extends State<SalarySlipScreen4> {
  @override
