...
import '../../app_widgets/custom_button.dart'; // For date formatting

class ApplyLeaveScreen3 extends StatefulWidget {
  const ApplyLeaveScreen3({super.key});

  @override
  State<ApplyLeaveScreen3> createState() => _ApplyLeaveScreen3State();
}

class _ApplyLeaveScreen3State extends State<ApplyLeaveScreen3> {
  DateTime? _fromDate;
  DateTime? _toDate;
