...
class SalarySlipScreen3 extends StatefulWidget {
  const SalarySlipScreen3({super.key});

  @override
  State<SalarySlipScreen3> createState() => _SalarySlipScreen3State();
}

class _SalarySlipScreen3State extends State<SalarySlipScreen3> {
  @override
